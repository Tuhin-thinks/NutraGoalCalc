...
def test_simple_g_scale(repo: JSONCatalogueRepository, calculator: DefaultNutritionCalculator):
...
def test_double_quantity_g(repo: JSONCatalogueRepository, calculator: DefaultNutritionCalculator):
    result = calculator.calculate(
...
def test_count_based_scaling(repo: JSONCatalogueRepository, calculator: DefaultNutritionCalculator):
    result = calculator.calculate(
...
def test_scoop_unit(repo: JSONCatalogueRepository, calculator: DefaultNutritionCalculator):
    result = calculator.calculate(
...
def test_bowl_unit(repo: JSONCatalogueRepository, calculator: DefaultNutritionCalculator):
    result = calculator.calculate(
...
def test_mixed_items_sum(repo: JSONCatalogueRepository, calculator: DefaultNutritionCalculator):
    result = calculator.calculate(
        [
...
def test_fiber_is_zero_when_absent(repo: JSONCatalogueRepository, calculator: DefaultNutritionCalculator):
    result = calculator.calculate(
        [CalculationItem(food_id="chicken_breast_100g", quantity=100)], repo
    )
...
def test_fiber_is_summed(repo: JSONCatalogueRepository, calculator: DefaultNutritionCalculator):
    result = calculator.calculate(
        [
...
def test_item_breakdown_correct(repo: JSONCatalogueRepository, calculator: DefaultNutritionCalculator):
    result = calculator.calculate(
...
def test_unknown_food_raises_keyerror(repo: JSONCatalogueRepository, calculator: DefaultNutritionCalculator):
